#!/usr/bin/env python3
"""Genera la plantilla de rejilla de la lámina fps_surfaces.
...
Salida: nefan-core/data/styles/_plantilla/fps/fps_surfaces.png
"""
...
OUT = (
    ...
    / "nefan-core" / "data" / "styles" / "_plantilla" / "fps" / "fps_surfaces.png"
)
...
def main() -> None:
    ...
    img.save(OUT)
    print(f"gen_fps_seed: escrito {OUT} ({ROWS}x{COLS} celdas)")

...
6. El cliente los materializa sin recargar la escena (`ui/conversacion.ts` para el diálogo, `world/materializar-spawn.ts` para las entidades nuevas, delta de historia…) — solo pinta lo que el bridge ya guardó

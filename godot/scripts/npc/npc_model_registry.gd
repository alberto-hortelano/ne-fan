...
const MODELS := {
	...
	"mutant": {
		"path": "res://assets/characters/mixamo/mutant/character.fbx",
		"display_name": "Mutant",
		"description": "Bestia mutante corpulenta de piel agrietada",
		"category": "enemy",
		"y_offset": -0.05,
		"has_weapon": false,
		"model_scale": 1.1,
	...
	"warrok": {
		"path": "res://assets/characters/mixamo/warrok/character.fbx",
		"display_name": "Warrok",
		"description": "Ogro de guerra masivo con hombreras de hueso",
		"category": "enemy",
		"y_offset": -0.05,
		"has_weapon": false,
		"model_scale": 1.15,
	...
	"skeletonzombie": {
		"path": "res://assets/characters/mixamo/skeletonzombie/character.fbx",
		"display_name": "Skeleton Zombie",
		"description": "Esqueleto reanimado con restos de carne putrefacta",
		"category": "enemy",
		"y_offset": -0.05,
		"has_weapon": false,
		"model_scale": 1.0,

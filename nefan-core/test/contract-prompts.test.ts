...
const CONTRACT_MARKERS: Record<string, string[]> = {
  ...
  "stage_instructions.md": ["stage", "exits", "to_place_id", "zone", "fourth_wall", "place_id", "edge", "style_tag", "stage_interior", "ambience", "volumes", "wall_h", "angle", "surroundings", "PLANO PRIMERO"],

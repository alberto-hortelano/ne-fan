...
const TABLA: ReadonlyArray<{ raw: string; acepta: boolean; nota: string }> = [
  ...
  { raw: "1000", acepta: true, nota: "el bloque 10: el primero que --parar no veía (#684)" },
  { raw: "1400", acepta: true, nota: "un bloque alto cualquiera" },
  { raw: "0100", acepta: true, nota: "cero a la izquierda: decimal en las tres capas, no octal en bash" },
  { raw: "40000", acepta: true, nota: "el borde superior, incluido" },
  { raw: "1", acepta: false, nota: "no múltiplo de 100: el bridge caería encima de la State API del vecino" },
  { raw: "150", acepta: false, nota: "no múltiplo de 100: el bloque son 100 puertos" },

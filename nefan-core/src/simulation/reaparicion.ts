 ...
 *  jugador). Preguntada por el punto del propio cadáver, esa consulta contesta
 *  «libre» pase lo que pase, así que cualquier rama que cuelgue de ella aquí
 *  nace muerta — #538 (2026-09-16) borró la que había, en vez de dejarla
 *  documentada como conducta. Si el jugador reaparece dentro de algo, sale
 *  andando por la regla «salir sí, entrar no» de `pasoDelJugador`, que es su
 *  hermano y el motivo de que no se quede atrapado.
 *

#!/usr/bin/env python3
"""Build a per-character base sprite browser inside labs/skinning/bases/<model>/.
...
`./labs/skinning/serve.sh` is enough to inspect everything.
...
<body>
  ...
  <p class="meta" style="margin-top:32px">
    <a href="../../index.html" style="color:#6c8cd5">← labs/skinning</a>
  </p>
...
def main() -> int:
    ...
    p.add_argument("--out", type=Path, default=None,
                   help="override output dir (default: labs/skinning/bases/<model>)")
    ...
    print(f"\n✓ {index_path}")
    print(f"  serve: ./labs/skinning/serve.sh → http://localhost:8911/bases/{args.model}/")
    return 0

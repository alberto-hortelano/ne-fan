...
```bash
python3 labs/skinning/run.py --preset y_bot_walk_4kf --frame-indices "0,3,6,10" --variants V4
```
...
`labs/skinning/index.html` (en la raíz del lab) lista todos los runs anteriores

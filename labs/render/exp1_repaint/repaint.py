...
Uso:
    python3 labs/render/exp1_repaint/repaint.py --tiles medieval [--only seedream4]
    python3 labs/render/exp1_repaint/repaint.py --tiles medieval,scifi --only nanobanana_pro,seedream4
"""

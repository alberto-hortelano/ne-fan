"""common.py — helpers compartidos del bench labs/render.
...
- score_image_for(): fidelidad de layout contra el blueprint de un fixture
  (reusa fidelity_score.py de labs/style y el segmentado SAM2 con caché).
"""
...
sys.path.insert(0, str(REPO / "labs/style"))

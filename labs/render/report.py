...
Uso: python3 labs/render/report.py
"""
...
def main() -> None:
    ...
    html = (
        "<!doctype html><meta charset=utf-8><title>labs/render 001 — alternativas de generación</title><style>"
        ...
        "</style><h1>labs/render · run 001 — alternativas de generación del mapa</h1>"

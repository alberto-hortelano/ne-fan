#!/usr/bin/env python3
"""labs/stage — bench de la segmentación del plató PINTADO (proscenio).
...
Uso:
  ...
  python labs/stage/run.py \
    ...
    --boxes labs/stage/boxes/posada_salon_v1.json \
    --name 001_salon [--peel]
...
<title>labs/stage — {args.name}</title>

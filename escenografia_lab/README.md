# escenografia_lab — bases SVG de plató de cine clásico
...
render_lab (E5 híbrido) subió seedream de 45→100% de fidelidad con un render
...
| clay → **seedream4** | $0.03 | Alta (confirma E5 de render_lab) | 2/3 con MARCO DE CARTA literal (la cláusula "Magic card" se lo pide — arreglable con "artwork only, no card frame" o recorte); estilo menos controlado. Palanca 5× más barata. |
...
```bash
cd escenografia_lab && python3 -m http.server 8912
